 ...
 */
class RequestCallbackParent extends CActiveRecord {
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['name', 'phone', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
        ]);
    }
    ...
    {
        if ($insert) {
            SystemNoticeEvent::doEvent('request_callback_created', [
                'item' => $this,
            ], 'Новая запись в таблице "Обратный звонок"');
        }
  ...
  'update' => 'updated_at',
    ...
    public static $search_model_class = '\app\models\search\RequestCallbackSearch';
    public static $model_title = 'Обратный звонок';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => true,
      'savePath' => '/up/requestcallback/og_image',
    ),
    'created_at' => 
    array (
      'sort' => 100010,
