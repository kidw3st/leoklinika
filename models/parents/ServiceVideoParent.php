 ...
 */
class ServiceVideoParent extends CActiveRecord {
    ...
    public static $search_model_class = '\app\models\search\ServiceVideoSearch';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => NULL,
      'savePath' => '/up/servicevideo/video',
    ),
    'image' => 
    array (
      'sort' => 30,
      ...
      'type' => 'file',
      'isImage' => 'on',
      'savePath' => '/up/servicevideo/image',
    ),
    'service_id' => 
    array (
      'sort' => 50,
