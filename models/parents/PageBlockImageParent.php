...
/**
 * This is the model class for table "page_block_image".
 *
 * @property integer $id
 ...
 */
class PageBlockImageParent extends CActiveRecord {
    public static function tableName()
    {
        return 'page_block_image';
    }

    public function rules()
    {
        return array_merge(parent::rules(), [
            [['title', 'image', 'text'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            ...
            [['video_id', 'page_block_id', 'weight'], 'integer', 'on' => ['default', 'admin']],
            [['public'], 'boolean', 'on' => ['admin']],

            [['title', 'video_id', 'text', 'page_block_id'], 'string', 'on' => 'search'],
    ...
    public static $search_model_class = '\app\models\search\PageBlockImageSearch';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => 'on',
      'savePath' => '/up/pageblockimage/image',
    ),
    'video_id' => 
    array (
      'sort' => 30,
