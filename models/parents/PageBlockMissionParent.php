...
/**
 * This is the model class for table "page_block_mission".
 *
 * @property integer $id
 ...
 */
class PageBlockMissionParent extends CActiveRecord {
    public static function tableName()
    {
        return 'page_block_mission';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['title', 'text'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            [['page_block_id', 'weight'], 'integer', 'on' => ['default', 'admin']],
            [['public'], 'boolean', 'on' => ['admin']],

            [['title', 'text', 'page_block_id'], 'string', 'on' => 'search'],
    ...
    public static $search_model_class = '\app\models\search\PageBlockMissionSearch';
    public static $model_title = 'Цель';
