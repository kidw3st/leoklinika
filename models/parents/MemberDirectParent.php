 ...
 */
class MemberDirectParent extends CActiveRecord {
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['title', 'title_m'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            [['public'], 'boolean', 'on' => ['admin']],
            [['weight'], 'integer', 'on' => ['default', 'admin']],

            [['title', 'title_m'], 'string', 'on' => 'search'],
    ...
    public static $search_model_class = '\app\models\search\MemberDirectSearch';
    public static $model_title = 'Направление';
