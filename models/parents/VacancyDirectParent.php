...
/**
 * This is the model class for table "vacancy_direct".
 *
 * @property integer $id
 ...
 */
class VacancyDirectParent extends CActiveRecord {
    public static function tableName()
    {
        return 'vacancy_direct';
    }
    ...
    public static $search_model_class = '\app\models\search\VacancyDirectSearch';
