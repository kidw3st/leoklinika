...
/**
 * This is the model class for table "page_block_faq".
 *
 * @property integer $id
 ...
 */
class PageBlockFaqParent extends CActiveRecord {
    ...
    public static $search_model_class = '\app\models\search\PageBlockFaqSearch';
