 ...
 */
class PageMetaParent extends CActiveRecord {
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['title', 'handle', 'seo_title', 'seo_keywords', 'og_title', 'og_image'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            ...
            [['title', 'handle', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
        ]);
    }
  ...
  'handle' => 'title',
    ...
    public static $search_model_class = '\app\models\search\PageMetaSearch';
    public static $model_title = 'Страница (Мета)';
