...
/**
 * This is the model class for table "page_block_advantage".
 *
 * @property integer $id
 ...
 */
class PageBlockAdvantageParent extends CActiveRecord {
    public static function tableName()
    {
        return 'page_block_advantage';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['title', 'icon'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            [['icon_input'], 'file', 'checkExtensionByMimeType' => false, 'extensions' => 'png,jpg,jpeg,svg', 'on' => ['default', 'admin']],
            [['icon_del'], 'boolean', 'on' => ['default', 'admin']],
            [['page_block_id', 'weight'], 'integer', 'on' => ['default', 'admin']],
            [['public'], 'boolean', 'on' => ['admin']],

            [['title', 'page_block_id'], 'string', 'on' => 'search'],
    ...
    public static $search_model_class = '\app\models\search\PageBlockAdvantageSearch';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => 'on',
      'savePath' => '/up/pageblockadvantage/icon',
    ),
    'page_block_id' => 
    array (
      'sort' => 100,
