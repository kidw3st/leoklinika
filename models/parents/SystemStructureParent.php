 ...
 */
class SystemStructureParent extends CActiveRecord {
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controller'], 'required', 'on' => ['default', 'admin']],
            [['controller', 'url', 'h1_title', 'seo_title', 'seo_keywords', 'og_title', 'og_image'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            ...
            [['controller', 'url', 'h1_title', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'controller_val' => 'Контроллер',
            'url' => 'Адрес',
            'url_val' => 'Адрес',
            'h1_title' => 'h1 заголвок',
            'h1_title_val' => 'h1 заголвок',
            'seo_title' => 'Seo title',
  ...
  'update' => 'updated_at',
    ...
    public static $search_model_class = '\app\models\search\SystemStructureSearch';
    public static $model_title = 'Структура';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => true,
      'savePath' => '/up/systemstructure/og_image',
    ),
    'created_at' => 
    array (
      'sort' => 100010,
