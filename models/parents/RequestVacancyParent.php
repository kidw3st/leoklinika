...
/**
 * This is the model class for table "request_vacancy".
 *
 * @property integer $id
 ...
 */
class RequestVacancyParent extends CActiveRecord {
    public static function tableName()
    {
        return 'request_vacancy';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['name', 'phone', 'file', 'seo_title', 'seo_keywords', 'og_title', 'og_image'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            [['name'], 'validateName', 'on' => ['default', 'admin']],
            [['email'], 'string', 'max' => 80, 'on' => ['default', 'admin']],
            [['email'], 'email', 'on' => ['default', 'admin']],
            [['vacancy_id'], 'integer', 'on' => ['default', 'admin']],
            [['file_input'], 'file', 'on' => ['default', 'admin']],
            [['file_del', 'og_image_del'], 'boolean', 'on' => ['default', 'admin']],
            ...
            [['name', 'phone', 'email', 'vacancy_id', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
        ]);
    }
    ...
    {
        if ($insert) {
            SystemNoticeEvent::doEvent('request_vacancy_created', [
                'item' => $this,
            ], 'Новая запись в таблице "Резюме"');
        }
  ...
  'update' => 'updated_at',
    ...
    public static $search_model_class = '\app\models\search\RequestVacancySearch';
    public static $model_title = 'Резюме';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => NULL,
      'savePath' => '/up/requestvacancy/file',
    ),
    'seo_title' => 
    array (
      'sort' => 100000,
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => true,
      'savePath' => '/up/requestvacancy/og_image',
    ),
    'created_at' => 
    array (
      'sort' => 100010,
