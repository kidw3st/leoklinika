...
/**
 * This is the model class for table "member_certificate".
 *
 * @property integer $id
 ...
 */
class MemberCertificateParent extends CActiveRecord {
    ...
    public static $search_model_class = '\app\models\search\MemberCertificateSearch';
    public static $model_title = 'Сертификат';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => 'on',
      'savePath' => '/up/membercertificate/image',
    ),
    'member_id' => 
    array (
      'sort' => 30,
