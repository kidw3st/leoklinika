...
/**
 * This is the model class for table "request_consult".
 *
 * @property integer $id
 ...
 */
class RequestConsultParent extends CActiveRecord {
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['service_id', 'member_id', 'action_id', 'page_id'], 'integer', 'on' => ['default', 'admin']],
            ...
            [['name', 'phone', 'service_id', 'member_id', 'action_id', 'page_id', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
        ]);
    }
    ...
    {
        if ($insert) {
            SystemNoticeEvent::doEvent('request_consult_created', [
                'item' => $this,
            ], 'Новая запись в таблице "Консультация"');
        }
  ...
  'update' => 'updated_at',
    ...
    public static $search_model_class = '\app\models\search\RequestConsultSearch';
    public static $model_title = 'Консультация';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => true,
      'savePath' => '/up/requestconsult/og_image',
    ),
    'created_at' => 
    array (
      'sort' => 100010,
