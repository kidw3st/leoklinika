...
/**
 * This is the model class for table "member_qualify".
 *
 * @property integer $id
 ...
 */
class MemberQualifyParent extends CActiveRecord {
    public static function tableName()
    {
        return 'member_qualify';
    }
    ...
    public static $search_model_class = '\app\models\search\MemberQualifySearch';
    public static $model_title = 'Квалификация';
