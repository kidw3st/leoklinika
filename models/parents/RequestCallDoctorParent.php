...
/**
 * This is the model class for table "request_call_doctor".
 *
 * @property integer $id
 ...
 */
class RequestCallDoctorParent extends CActiveRecord {
    public static function tableName()
    {
        return 'request_call_doctor';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['name', 'phone', 'page_id', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
        ]);
    }
    ...
    {
        if ($insert) {
            SystemNoticeEvent::doEvent('request_call_doctor_created', [
                'item' => $this,
            ], 'Новая запись в таблице "Вызов врача"');
        }
  ...
  'update' => 'updated_at',
    ...
    public static $search_model_class = '\app\models\search\RequestCallDoctorSearch';
    public static $model_title = 'Вызов врача';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => true,
      'savePath' => '/up/requestcalldoctor/og_image',
    ),
    'created_at' => 
    array (
      'sort' => 100010,
