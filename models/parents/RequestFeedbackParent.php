 ...
 */
class RequestFeedbackParent extends CActiveRecord {
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['name', 'phone', 'text', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string', 'on' => 'search'],
        ]);
    }
    ...
    {
        if ($insert) {
            SystemNoticeEvent::doEvent('request_feedback_created', [
                'item' => $this,
            ], 'Новая запись в таблице "Обратная связь"');
        }
  ...
  'update' => 'updated_at',
    ...
    public static $search_model_class = '\app\models\search\RequestFeedbackSearch';
    public static $model_title = 'Обратная связь';
  ...
  array (
    ...
    array (
      ...
      'type' => 'file',
      'isImage' => true,
      'savePath' => '/up/requestfeedback/og_image',
    ),
    'created_at' => 
    array (
      'sort' => 100010,
