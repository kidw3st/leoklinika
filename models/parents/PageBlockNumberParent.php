 ...
 */
class PageBlockNumberParent extends CActiveRecord {
    public static function tableName()
    {
        return 'page_block_number';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['title', 'number'], 'string', 'max' => 255, 'on' => ['default', 'admin']],
            [['page_block_id', 'weight'], 'integer', 'on' => ['default', 'admin']],
            [['public'], 'boolean', 'on' => ['admin']],

            [['title', 'number', 'page_block_id'], 'string', 'on' => 'search'],
    ...
    public static $search_model_class = '\app\models\search\PageBlockNumberSearch';
    public static $model_title = 'Показатель';
