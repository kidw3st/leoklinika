 ...
 */
class ArticleSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\Article';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['title', 'handle', 'description', 'member_id', 'date', 'text', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string'],
            [['public'], 'number'],
            [['weight'], 'integer'],
        ]);
    }
