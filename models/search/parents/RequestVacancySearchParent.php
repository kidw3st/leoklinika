 ...
 */
class RequestVacancySearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\RequestVacancy';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['name', 'phone', 'email', 'vacancy_id', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string'],
        ]);
    }
