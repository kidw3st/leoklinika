...
/**
 * This is the model class for table "page_block_number".
 *
 ...
 */
class PageBlockNumberSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\PageBlockNumber';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['title', 'number', 'page_block_id'], 'string'],
            [['public'], 'number'],
            [['weight'], 'integer'],
        ]);
    }
    ...
    public function field_filter_input($attribute) {
        ...
        if ($attribute == 'number') return $this->filter_string($attribute);
    ...
    public function search_field_number($query, $parent_atttribute = '') {
        $this->search_type_string($query, 'number', $parent_atttribute);
    }
