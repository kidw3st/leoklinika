 ...
 */
class RequestConsultSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\RequestConsult';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['name', 'phone', 'service_id', 'member_id', 'action_id', 'page_id', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string'],
        ]);
    }
