 ...
 * @property string $direct_id
 * @property integer $public
 * @property string $weight
 */
class VacancySearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\Vacancy';
    ...
    public function field_filter_input($attribute) {
        ...
        if ($attribute == 'direct_id') return $this->filter_link_ITo1($attribute);
    ...
    public function search_field_direct_id($query, $parent_atttribute = '') {
        $this->search_type_link_ITo1($query, 'direct_id', $parent_atttribute);
    }
