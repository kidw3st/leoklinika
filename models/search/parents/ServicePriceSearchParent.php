 ...
 * @property integer $is_consult
 * @property string $actions
 * @property string $service_id
 * @property integer $public
 * @property string $weight
 */
class ServicePriceSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\ServicePrice';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['price', 'price_from', 'is_consult', 'public'], 'number'],
            [['weight'], 'integer'],
        ]);
    }
    ...
    public function field_filter_input($attribute) {
        ...
        if ($attribute == 'is_consult') return $this->filter_checkbox($attribute);
    ...
    public function search_field_is_consult($query, $parent_atttribute = '') {
        $this->search_type_checkbox($query, 'is_consult', $parent_atttribute);
    }
