 ...
 */
class ServiceLinkSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\ServiceLink';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['title', 'link', 'link_title', 'service_id'], 'string'],
    ...
    public function field_filter_input($attribute) {
        ...
        if ($attribute == 'background_color') return $this->filter_select($attribute);
    ...
    public function search_field_background_color($query, $parent_atttribute = '') {
        $this->search_type_select($query, 'background_color', $parent_atttribute);
    }
