...
/**
 * This is the model class for table "member_direct".
 *
 ...
 */
class MemberDirectSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\MemberDirect';
    ...
    public function field_filter_input($attribute) {
        ...
        if ($attribute == 'title_m') return $this->filter_string($attribute);
    ...
    public function search_field_title_m($query, $parent_atttribute = '') {
        $this->search_type_string($query, 'title_m', $parent_atttribute);
    }
