 ...
 */
class SystemUserConfirmSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\SystemUserConfirm';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['user_id', 'code', 'created_at', 'updated_at'], 'string'],
            [['type'], 'string', 'max' => 50],
        ]);
    }
