 ...
 */
class RequestActionSearchParent extends ModelSearch {
    public static $main_model_class = '\\app\\models\\RequestAction';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['name', 'phone', 'block_id', 'seo_title', 'seo_description', 'seo_keywords', 'og_title', 'og_description', 'created_at', 'updated_at'], 'string'],
        ]);
    }
