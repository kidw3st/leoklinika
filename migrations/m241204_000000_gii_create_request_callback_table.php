...
class m241204_000000_gii_create_request_callback_table extends Migration
{
    public function up()
    {
        ...
        (new \app\models\SystemAdminMenu(['title' => 'Обратный звонок', 'model' => 'RequestCallback', 'public' => 1]))->controllerSave();
    }
